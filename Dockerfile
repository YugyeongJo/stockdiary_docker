...
ARG BRANCH_NAME=stockdiary_project
ARG DIR_NAME=stockdiary_project # 변경대상
...
RUN git clone https://github.com/YugyeongJo/stockdiary_project_fastapi ${DIR_NAME}           # 변경대상
